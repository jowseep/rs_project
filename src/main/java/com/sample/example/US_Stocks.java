...
public class US_Stocks {
    String update;
    String term;
    List<List<String>> us_ranking = new ArrayList<>();

    List<List<String>> us_etf_ranking = new ArrayList<>();
    List<List<String>> us_adr_ranking = new ArrayList<>();
    List<List<String>> ch_ranking = new ArrayList<>();
    List<List<String>> ch_etf_ranking = new ArrayList<>();
    List<List<String>> as_ranking = new ArrayList<>();
